#ifndef KERNEL_BITMAP_FONT
#define KERNEL_BITMAP_FONT

const unsigned char bitmap_ascii_offset = 32;
const unsigned char bitmap_table_size = 93 + bitmap_ascii_offset;

unsigned char bitmap_font[95][13] = {
